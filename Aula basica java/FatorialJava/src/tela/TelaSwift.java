 ...
 * @author marce
 */
public class TelaSwift extends javax.swing.JFrame {

    /**
     * Creates new form TelaSwift
     */
    public TelaSwift() {
        initComponents();
    }
    ...
    private void spnValorStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_spnValorStateChanged
        ...
        lblResuntado.setText(Integer.toString(f));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaSwift.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
